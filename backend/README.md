...
## Project Structure
    ...
    ├── testapiautostoryboa_68954  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_68954`
...
2. Clone this repo and `cd testapiautostoryboa_68954`
